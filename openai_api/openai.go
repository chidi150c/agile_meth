...
type OpenAIServicer interface{
	ProcessAiMessage(msg string)(map[string]string, error)
...
func (o *OpenAI)ProcessAiMessage(msg string)(map[string]string, error){
